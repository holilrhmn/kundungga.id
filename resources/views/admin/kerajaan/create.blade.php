...
@section('content')
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">Tambah Data Kerajaan</h3>
        </div>
        <div class="card-body">
            <form  action="{{ route('admin.kerajaan.store')}}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-group">
                    ...
                    placeholder="Masukkan Penjelasan Pemerintahan"> {{old ('pemerintahan') }} </textarea>
                    @error('pemerintahan')
                        <span  class="text-danger"> {{ $message }} </span>
                    @enderror
                </div>
                <div class="form-group">
                    ...
                    placeholder="Masukkan Tradisi Lisan"> {{old ('tradisi_lisan') }} </textarea>
                    @error('tradisi_lisan')
                        <span  class="text-danger"> {{ $message }} </span>
                    @enderror
                </div>
                <div class="form-group">
                    ...
                    placeholder="Masukkan Adat Istiadat"> {{old ('adat_istiadat') }} </textarea>
                    @error('adat_istiadat')
                        <span  class="text-danger"> {{ $message }} </span>
                    @enderror
                </div>
                <div class="form-group">
                    ...
                    placeholder="Masukkan ritus"> {{old ('ritus') }} </textarea>
                    @error('ritus')
                        <span  class="text-danger"> {{ $message }} </span>
                    @enderror
                </div>
                <div class="form-group">
                    ...
                    placeholder="Masukkan seni"> {{old ('seni') }} </textarea>
                    @error('seni')
                        <span  class="text-danger"> {{ $message }} </span>
                    @enderror
                </div>
                <div class="form-group">
                    ...
                    placeholder="Masukkan Bahasa"> {{old ('bahasa') }} </textarea>
                    @error('bahasa')
                        <span  class="text-danger"> {{ $message }} </span>
                    @enderror
                </div>
                <div class="form-group">
                    ...
                    placeholder="Masukkan Cagar Budaya"> {{old ('cagar_budaya') }} </textarea>
                    @error('cagar_budaya')
                        <span  class="text-danger"> {{ $message }} </span>
                    @enderror
                </div>
